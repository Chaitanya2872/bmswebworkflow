...
//   unknown: 5,
//   assets: [
//     { name: "Laptop ABC123", category: "Laptops", status: "Allocated", value: "$1200", location: "New York" },
//     { name: "Office Chair B", category: "Furniture", status: "In Maintenance", value: "$150", location: "San Angeles" },
//     { name: "Printer XYZ789", category: "Machinery", status: "Allocated", value: "$500", location: "Chicago" },
//     { name: "Projector LMN456", category: "Other", status: "Status Unknown", value: "$800", location: "Austin" },
//   ] as Asset[],
//   pieChart: [
...
//               <YAxis />
//               <Tooltip />
//               <Line type="monotone" dataKey="value" stroke="#4F86F7" strokeWidth={3} dot={false} />
//             </LineChart>
//           </ResponsiveContainer>
//         </div>
//       </div>
        ...
        <div className="chart-box">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              ...
              {/* ✅ Custom Legend for black bold names */}
              <Legend
                layout="vertical"
                align="right"
